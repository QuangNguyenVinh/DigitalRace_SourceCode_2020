...
int ControlCar::checkRight(const Mat &bin, Rect rightRect)
{
    Mat right = bin(rightRect);
    imshow("Right", right);
...
void ControlCar::driveCar(const Mat &view, const Mat &view1,float velocity,int flag, bool flag2, Rect obj)
{
    ...
    //int slowleft = checkRight(dst4, Rect(0, 80, 150, 20));
    //int slowright = checkRight(dst4, Rect(170, 80, 150, 20));
